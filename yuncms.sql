...
--
-- Table structure for table `yc_admin_log`
--
...
CREATE TABLE `yc_admin_log` (
  ...
  `log_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '日志类型：0管理员；1用户中心',
  ...
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='后台管理员操作日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `yc_admin_log`
--

LOCK TABLES `yc_admin_log` WRITE;
/*!40000 ALTER TABLE `yc_admin_log` DISABLE KEYS */;
INSERT INTO `yc_admin_log` VALUES (1,0,00000000001,'admin/menu/save','Menu','新增菜单','管理员admin新增菜单admin/menu/save成功!',01487821207,0,'127.0.0.1'),(2,0,00000000001,'admin/menu/update','Menu','编辑菜单','管理员admin编辑菜单系统管理(admin/menu/update)成功!',01487830122,0,'127.0.0.1'),(3,0,00000000001,'admin/menu/update','Menu','编辑菜单','管理员admin编辑菜单系统管理(admin/menu/update)成功!',01487830133,0,'127.0.0.1'),(4,0,00000000001,'admin/menu/save','Menu','新增菜单','管理员admin新增菜单再次测试一下(admin/menu/save)成功!',01487830445,0,'127.0.0.1'),(5,0,00000000001,'admin/menu/update','Menu','编辑菜单','管理员admin编辑菜单栏目管理(admin/menu/update)成功!',01487830475,0,'127.0.0.1'),(6,0,00000000001,'admin/menu/update','Menu','编辑菜单','管理员admin编辑菜单扩展管理(admin/menu/update)成功!',01487830503,0,'127.0.0.1'),(7,0,00000000001,'admin/authgroup/save','AuthGroup','新增用户组','管理员admin新增用户组运营组成功!',01487925185,0,'127.0.0.1'),(8,0,00000000001,'admin/menu/save','Menu','新增菜单','管理员admin新增菜单权限列表(admin/menu/save)成功!',01487928336,0,'127.0.0.1');
/*!40000 ALTER TABLE `yc_admin_log` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `yc_admin_user` VALUES (1,'admin','45a1a3e33cf2739383ee9cd6e512e8a4',3306,'68527761@qq.com','18671418772','',1487918073,'127.0.0.1',0,0,1486707687);
...
CREATE TABLE `yc_auth_group` (
  ...
  `status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '用户组状态：为1正常，为0禁用,2为删除',
  ...
  PRIMARY KEY (`gid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='用户权限组';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `yc_auth_group` VALUES (1,1,'超级管理员','超级管理员，拥有系统的最大权限！',1,'',01487840292),(2,1,'运营组','负责网站上推广运营工作',1,'',01487925185);
...
CREATE TABLE `yc_auth_rule` (
  ...
  `condition` text NOT NULL COMMENT '规则附加条件',
  PRIMARY KEY (`id`),
...
CREATE TABLE `yc_category` (
  ...
  `cate_description` text NOT NULL COMMENT '网站描述',
...
CREATE TABLE `yc_comment` (
  ...
  `com_content` text NOT NULL COMMENT '评论内容',
  `com_reply_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '管理员回复人id',
  `com_reply_msg` text NOT NULL COMMENT '管理员回复内容',
...
CREATE TABLE `yc_config` (
  ...
  `forbitip` text NOT NULL COMMENT '禁止访问IP（英文逗号隔开）',
  ...
  `description` text NOT NULL COMMENT '网站描述，网站简介',
...
INSERT INTO `yc_config` VALUES ('yuncms内容管理系统','www.yunalading.com','','','','','service@yunalading.com',68527761,'yuncms  thinkphp5 内容管理系统 文章管理系统','','static/images/logo.png',0);
/*!40000 ALTER TABLE `yc_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `yc_guest_book`
--
...
CREATE TABLE `yc_guest_book` (
  ...
  `guest_msg` text NOT NULL COMMENT '留言内容',
...
--
-- Dumping data for table `yc_guest_book`
--

LOCK TABLES `yc_guest_book` WRITE;
/*!40000 ALTER TABLE `yc_guest_book` DISABLE KEYS */;
/*!40000 ALTER TABLE `yc_guest_book` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `yc_menu` (
  ...
  KEY `pid` (`pid`),
  KEY `status` (`status`)
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='后台菜单管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `yc_menu` VALUES (1,'后台首页','admin','fa-download',0,1,'admin/index/index',1,'','',1487749964,0,0),(2,'系统管理','admin','fa-search',0,2,'admin/system/read',0,'','',1487830133,0,0),(3,'栏目管理','admin','fa-lock',0,3,'admin/category/read',0,'','',1487830475,0,0),(4,'内容管理','admin','',0,4,'admin/article/read',0,'','',1486800730,0,0),(5,'模型管理','admin','',0,5,'admin/module/read',0,'','',1486800730,0,0),(6,'权限管理','admin','',0,6,'admin/auth/read',0,'','',1486800730,0,0),(7,'菜单管理','admin','',0,7,'admin/menu/read',0,'','',1486800730,0,0),(8,'用户管理','admin','',0,8,'admin/admin_user/read',0,'','',1486800730,0,0),(9,'扩展管理','admin','fa-key',0,9,'admin/extend/read',0,'','',1487830503,0,0),(10,'管理员','admin','',8,10,'admin/admin_user/index',0,'','',1486800730,0,0),(11,'管理组','admin','',8,11,'admin/auth_group/index',0,'','',1486800730,0,0),(12,'后台菜单','admin','fa-cog',7,12,'admin/menu/index',0,'','',1487665206,0,0),(13,'前台菜单','admin','',7,13,'admin/menu/home',1,'','',1487665007,0,0),(14,'测试菜单','admin','fa-asterisk',0,102,'admin/test/test',0,'','',1487670517,0,0),(15,'日志管理','admin','fa-plane',0,150,'admin/admin_log/read',0,'','',1487752280,0,0),(16,'管理员日志','admin','fa-user',15,100,'admin/admin_log/index',0,'','',1487754872,0,0),(18,'test2','admin','fa-repeat',0,100,'admin/test/index',0,'','',1487821207,0,0),(20,'权限列表','admin','fa-envelope-o',6,150,'admin/auth_rule/index',0,'','',1487928336,0,0);
...
CREATE TABLE `yc_zt` (
  ...
  `zt_description` text NOT NULL COMMENT '描述',
  `zt_thumb` varchar(255) NOT NULL DEFAULT '' COMMENT '缩略图',
  `zt_content` text NOT NULL COMMENT '内容',
...
-- Dump completed on 2017-02-25 14:08:06
