...
CREATE TABLE `yc_contents` (
  ...
  `tag_id` int(11) DEFAULT '0' COMMENT '内容标签',
...
CREATE TABLE `yc_menus` (
  ...
  `menu_target` int(1) DEFAULT NULL COMMENT '菜单打开方式0当前页面打开1新页面打开',
  `menu_sort` int(11) DEFAULT '0' COMMENT '菜单排序',
  `parent_menu_id` int(11) DEFAULT '0' COMMENT '上级菜单编号',
  `update_time` int(11) DEFAULT NULL COMMENT '更新时间',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`menu_id`),
...
CREATE TABLE `yc_pages` (
  ...
  `tag_id` int(11) DEFAULT '0' COMMENT '单页标签',
  `delete_time` int(11) DEFAULT NULL COMMENT '软删除',
  `update_time` int(11) DEFAULT NULL COMMENT '更新时间',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
