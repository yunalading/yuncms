...
--
-- Host: localhost
-- Generation Time: 2017-05-05 03:01:07
...
CREATE TABLE `yc_area` (
  `area_id` int(11) NOT NULL COMMENT '地区编号',
...
INSERT INTO `yc_area` (`area_id`, `area_name`, `area_parent_id`, `area_sort`, `area_deep`, `area_region`) VALUES
(1, '北京', 0, 0, 1, '华北'),
(2, '天津', 0, 0, 1, '华北'),
(3, '河北', 0, 0, 1, '华北'),
(4, '山西', 0, 0, 1, '华北'),
...
--
-- 表的结构 `yc_article_properties`
--

CREATE TABLE `yc_article_properties` (
  `id` int(11) NOT NULL COMMENT '字段编号',
...
(1, 1, 'yuncms', 'yuncms', 'yuncms', 'yuncms', '默认分类', 'list', 'info', 1000, 0, NULL, 1493282519, 1493282519, 0),
...
CREATE TABLE `yc_comments` (
  `content_comment_id` int(11) NOT NULL COMMENT '内容评论编号',
...
--
-- 表的结构 `yc_content_tags`
--

CREATE TABLE `yc_content_tags` (
  `content_tag_id` int(11) NOT NULL COMMENT '内容标签编号',
  `content_id` int(11) DEFAULT NULL COMMENT '内容编号',
...
CREATE TABLE `yc_edu_level` (
  `edu_level_id` int(11) NOT NULL COMMENT '文化程度编号',
...
CREATE TABLE `yc_guestbook` (
  `guestbook_id` int(11) NOT NULL COMMENT '留言编号',
...
CREATE TABLE `yc_imgs` (
  `img_id` int(11) NOT NULL COMMENT '图片编号',
...
CREATE TABLE `yc_img_type` (
  `img_type_id` int(11) NOT NULL COMMENT '图片分类编号',
...
(1, '默认', 0, NULL, 1493097912, 1493097912),
...
--
-- 表的结构 `yc_model_properties`
--

CREATE TABLE `yc_model_properties` (
  `model_properties_id` int(11) NOT NULL COMMENT '模型属性编号',
  `model_id` int(11) DEFAULT NULL COMMENT '模型编号',
  ...
  `create_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '添加时间',
  `update_time` int(11) UNSIGNED NOT NULL DEFAULT '0' COMMENT '修改时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='模型属性表';

--
-- 转存表中的数据 `yc_model_properties`
--
...
--
-- 表的结构 `yc_oauth_members`
--

CREATE TABLE `yc_oauth_members` (
  `oauth_member_id` int(11) NOT NULL COMMENT '编号',
...
CREATE TABLE `yc_role` (
  `role_id` int(11) NOT NULL COMMENT '管理员角色编号',
...
INSERT INTO `yc_role` (`role_id`, `role_name`, `del_lock`, `delete_time`, `update_time`, `create_time`) VALUES
(1, '超级管理员', 0, NULL, NULL, 1493370661);
...
CREATE TABLE `yc_role_access` (
  `user_role_access_id` int(11) NOT NULL COMMENT '管理员角色权限编号',
...
--
-- 转存表中的数据 `yc_role_access`
--

INSERT INTO `yc_role_access` (`user_role_access_id`, `role_id`, `access`) VALUES
(1, 1, '/admin/system/index.html'),
(2, 1, '/admin/system/clear.html'),
(3, 1, '/admin/content/index.html'),
(4, 1, '/admin/content/delete.html'),
(5, 1, '/admin/content/edit.html'),
(6, 1, '/admin/comment/index.html'),
(7, 1, '/admin/comment/delete.html'),
(8, 1, '/admin/comment/edit.html'),
(9, 1, '/admin/page/index.html'),
(10, 1, '/admin/page/delete.html'),
(11, 1, '/admin/page/edit.html'),
(12, 1, '/admin/category/index.html'),
(13, 1, '/admin/category/remove.html'),
(14, 1, '/admin/category/edit.html'),
(15, 1, '/admin/model/index.html'),
(16, 1, '/admin/model/remove.html'),
(17, 1, '/admin/model/edit.html'),
(18, 1, '/admin/model/attr.html'),
(19, 1, '/admin/model/attrdelete.html'),
(20, 1, '/admin/model/attrupdate.html'),
(21, 1, '/admin/member/index.html'),
(22, 1, '/admin/tag/index.html'),
(23, 1, '/admin/tag/remove.html'),
(24, 1, '/admin/tag/edit.html'),
(25, 1, '/admin/guestbook/index.html'),
(26, 1, '/admin/ad/general.html'),
(27, 1, '/admin/ad/remove.html'),
(28, 1, '/admin/ad/generaledit.html'),
(29, 1, '/admin/ad/script.html'),
(30, 1, '/admin/ad/scriptedit.html'),
(31, 1, '/admin/ad/slide.html'),
(32, 1, '/admin/ad/slideedit.html'),
...
(40, 1, '/admin/email/index.html'),
(41, 1, '/admin/email/testmail.html'),
(42, 1, '/admin/email/sendEmail.html'),
(43, 1, '/admin/sms/index.html'),
(44, 1, '/admin/oauth/qq.html'),
(45, 1, '/admin/oauth/wechat.html'),
(46, 1, '/admin/oauth/weibo.html'),
(47, 1, '/admin/user/index.html'),
(48, 1, '/admin/user/update.html'),
(49, 1, '/admin/user/remove.html'),
(50, 1, '/admin/user/trash.html'),
(51, 1, '/admin/role/index.html'),
(52, 1, '/admin/role/update.html'),
(53, 1, '/admin/role/remove.html'),
(54, 1, '/admin/role/trash.html'),
(55, 1, '/admin/area/index.html'),
(56, 1, '/admin/area/remove.html'),
(57, 1, '/admin/area/edit.html'),
(58, 1, '/admin/edu/index.html'),
(59, 1, '/admin/edu/remove.html'),
(60, 1, '/admin/edu/update.html'),
(61, 1, '/admin/upload/index.html'),
(62, 1, '/admin/upload/edit.html'),
(63, 1, '/admin/constant/index.html'),
(64, 1, '/admin/constant/remove.html'),
(65, 1, '/admin/constant/update.html'),
(66, 1, '/admin/links/index.html'),
(67, 1, '/admin/links/remove.html'),
(68, 1, '/admin/links/update.html');
...
CREATE TABLE `yc_slides_imgs` (
  `slide_img_id` int(11) NOT NULL COMMENT '幻灯片图片编号',
...
INSERT INTO `yc_tags` (`tag_id`, `tag_name`) VALUES
(1, '默认标签');
...
CREATE TABLE `yc_users` (
  `user_id` int(11) NOT NULL COMMENT '管理员用户编号',
  `role_id` int(11) DEFAULT NULL COMMENT '管理员角色编号',
...
INSERT INTO `yc_users` (`user_id`, `role_id`, `nickname`, `avatar`, `username`, `password`, `email`, `phone`, `qq`, `last_login_time`, `last_login_ip`, `del_lock`, `state`, `delete_time`, `update_time`, `create_time`) VALUES
(1, 1, '超级管理员', NULL, 'admin', '0b77520f93de693bdab0060746e38165', '68527761@qq.com', '18671418772', '68527761', 0, '127.0.0.1', 0, 0, NULL, 1493704474, 1493704480);
...
--
-- Indexes for table `yc_ad_code`
--
ALTER TABLE `yc_ad_code`
  ADD PRIMARY KEY (`ad_code_key`);

--
-- Indexes for table `yc_ad_images`
--
ALTER TABLE `yc_ad_images`
  ADD PRIMARY KEY (`ad_img_key`);

--
-- Indexes for table `yc_ad_text`
--
ALTER TABLE `yc_ad_text`
  ADD PRIMARY KEY (`ad_text_key`);

--
-- Indexes for table `yc_area`
--
ALTER TABLE `yc_area`
  ADD PRIMARY KEY (`area_id`);

--
-- Indexes for table `yc_article_properties`
--
ALTER TABLE `yc_article_properties`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yc_category`
--
ALTER TABLE `yc_category`
  ADD PRIMARY KEY (`category_id`),
  ADD UNIQUE KEY `category_unique` (`seo_url`),
  ADD KEY `FK_CATEGORY_MODEL` (`model_id`);

--
-- Indexes for table `yc_comments`
--
ALTER TABLE `yc_comments`
  ADD PRIMARY KEY (`content_comment_id`),
  ADD KEY `FK_CONTENT_COMMENTS` (`content_id`);

--
-- Indexes for table `yc_contents`
--
ALTER TABLE `yc_contents`
  ADD PRIMARY KEY (`content_id`),
  ADD UNIQUE KEY `content_unique` (`seo_url`),
  ADD KEY `FK_CATEGORY_CONTENTS` (`category_id`),
  ADD KEY `FK_USER_CEONTENTS` (`user_id`);

--
-- Indexes for table `yc_content_tags`
--
ALTER TABLE `yc_content_tags`
  ADD PRIMARY KEY (`content_tag_id`),
  ADD KEY `FK_CONTENT_TAGS` (`content_id`),
  ADD KEY `FK_TAG_CONTENTS` (`tag_id`);

--
-- Indexes for table `yc_edu_level`
--
ALTER TABLE `yc_edu_level`
  ADD PRIMARY KEY (`edu_level_id`);

--
-- Indexes for table `yc_guestbook`
--
ALTER TABLE `yc_guestbook`
  ADD PRIMARY KEY (`guestbook_id`);

--
-- Indexes for table `yc_imgs`
--
ALTER TABLE `yc_imgs`
  ADD PRIMARY KEY (`img_id`),
  ADD KEY `FK_TYPE_IMGS` (`img_type_id`);

--
-- Indexes for table `yc_img_type`
--
ALTER TABLE `yc_img_type`
  ADD PRIMARY KEY (`img_type_id`),
  ADD UNIQUE KEY `img_type_unique` (`type_name`);

--
-- Indexes for table `yc_links`
--
ALTER TABLE `yc_links`
  ADD PRIMARY KEY (`link_id`);

--
-- Indexes for table `yc_members`
--
ALTER TABLE `yc_members`
  ADD PRIMARY KEY (`member_id`),
  ADD UNIQUE KEY `member_unique` (`username`),
  ADD KEY `FK_MEMBER_AREA` (`area_id`),
  ADD KEY `FK_MEMBER_EDU_LEVEL` (`edu_level_id`);

--
-- Indexes for table `yc_menus`
--
ALTER TABLE `yc_menus`
  ADD PRIMARY KEY (`menu_id`),
  ADD KEY `FK_NAV_MENUS` (`nav_key`);

--
-- Indexes for table `yc_model`
--
ALTER TABLE `yc_model`
  ADD PRIMARY KEY (`model_id`),
  ADD UNIQUE KEY `model_unique` (`model_name`);

--
-- Indexes for table `yc_model_attr`
--
ALTER TABLE `yc_model_attr`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `yc_model_properties`
--
ALTER TABLE `yc_model_properties`
  ADD PRIMARY KEY (`model_properties_id`),
  ADD KEY `FK_MODEL_PROPERTIES` (`model_id`);

--
-- Indexes for table `yc_navs`
--
ALTER TABLE `yc_navs`
  ADD PRIMARY KEY (`nav_key`);

--
-- Indexes for table `yc_oauth_members`
--
ALTER TABLE `yc_oauth_members`
  ADD PRIMARY KEY (`oauth_member_id`),
  ADD UNIQUE KEY `oauth_member_unique` (`openid`),
  ADD KEY `FK_MEMBER_OAUTH` (`member_id`);

--
-- Indexes for table `yc_pages`
--
ALTER TABLE `yc_pages`
  ADD PRIMARY KEY (`page_id`),
  ADD UNIQUE KEY `page_unique` (`seo_url`);

--
-- Indexes for table `yc_role`
--
ALTER TABLE `yc_role`
...
--
-- Indexes for table `yc_role_access`
--
ALTER TABLE `yc_role_access`
  ADD PRIMARY KEY (`user_role_access_id`),
  ADD KEY `FK_ROLE_ACCESS` (`role_id`);

--
-- Indexes for table `yc_slides`
--
ALTER TABLE `yc_slides`
  ADD PRIMARY KEY (`slide_key`);

--
-- Indexes for table `yc_slides_imgs`
--
ALTER TABLE `yc_slides_imgs`
  ADD PRIMARY KEY (`slide_img_id`),
  ADD KEY `FK_SLIDE_IMGS` (`slide_key`);

--
-- Indexes for table `yc_tags`
--
ALTER TABLE `yc_tags`
...
--
-- 使用表AUTO_INCREMENT `yc_area`
--
ALTER TABLE `yc_area`
  MODIFY `area_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '地区编号', AUTO_INCREMENT=45056;
--
-- 使用表AUTO_INCREMENT `yc_article_properties`
--
ALTER TABLE `yc_article_properties`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '字段编号', AUTO_INCREMENT=5;
--
-- 使用表AUTO_INCREMENT `yc_category`
--
ALTER TABLE `yc_category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '类别编号', AUTO_INCREMENT=7;
--
-- 使用表AUTO_INCREMENT `yc_comments`
--
ALTER TABLE `yc_comments`
  MODIFY `content_comment_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '内容评论编号';
--
-- 使用表AUTO_INCREMENT `yc_contents`
--
ALTER TABLE `yc_contents`
  MODIFY `content_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '内容编号', AUTO_INCREMENT=6;
--
-- 使用表AUTO_INCREMENT `yc_content_tags`
--
ALTER TABLE `yc_content_tags`
  MODIFY `content_tag_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '内容标签编号';
--
-- 使用表AUTO_INCREMENT `yc_edu_level`
--
ALTER TABLE `yc_edu_level`
  MODIFY `edu_level_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '文化程度编号';
--
-- 使用表AUTO_INCREMENT `yc_guestbook`
--
ALTER TABLE `yc_guestbook`
  MODIFY `guestbook_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '留言编号';
--
-- 使用表AUTO_INCREMENT `yc_imgs`
--
ALTER TABLE `yc_imgs`
  MODIFY `img_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '图片编号';
--
-- 使用表AUTO_INCREMENT `yc_img_type`
--
ALTER TABLE `yc_img_type`
  MODIFY `img_type_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '图片分类编号';
--
-- 使用表AUTO_INCREMENT `yc_links`
--
ALTER TABLE `yc_links`
  MODIFY `link_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '友情链接编号', AUTO_INCREMENT=2;
--
-- 使用表AUTO_INCREMENT `yc_members`
--
ALTER TABLE `yc_members`
  MODIFY `member_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '会员编号';
--
-- 使用表AUTO_INCREMENT `yc_menus`
--
ALTER TABLE `yc_menus`
  MODIFY `menu_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '菜单编号';
--
-- 使用表AUTO_INCREMENT `yc_model`
--
ALTER TABLE `yc_model`
  MODIFY `model_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '模型编号', AUTO_INCREMENT=4;
--
-- 使用表AUTO_INCREMENT `yc_model_attr`
--
ALTER TABLE `yc_model_attr`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- 使用表AUTO_INCREMENT `yc_model_properties`
--
ALTER TABLE `yc_model_properties`
  MODIFY `model_properties_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '模型属性编号', AUTO_INCREMENT=6;
--
-- 使用表AUTO_INCREMENT `yc_oauth_members`
--
ALTER TABLE `yc_oauth_members`
  MODIFY `oauth_member_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '编号';
--
-- 使用表AUTO_INCREMENT `yc_pages`
--
ALTER TABLE `yc_pages`
  MODIFY `page_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '页面编号';
--
-- 使用表AUTO_INCREMENT `yc_role`
--
ALTER TABLE `yc_role`
  MODIFY `role_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '管理员角色编号', AUTO_INCREMENT=2;
--
-- 使用表AUTO_INCREMENT `yc_role_access`
--
ALTER TABLE `yc_role_access`
  MODIFY `user_role_access_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '管理员角色权限编号', AUTO_INCREMENT=69;
--
-- 使用表AUTO_INCREMENT `yc_slides_imgs`
--
ALTER TABLE `yc_slides_imgs`
  MODIFY `slide_img_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '幻灯片图片编号';
--
-- 使用表AUTO_INCREMENT `yc_tags`
--
ALTER TABLE `yc_tags`
  MODIFY `tag_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '标签编号', AUTO_INCREMENT=2;
--
-- 使用表AUTO_INCREMENT `yc_users`
--
ALTER TABLE `yc_users`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '管理员用户编号', AUTO_INCREMENT=2;
--
-- 限制导出的表
--
...
--
ALTER TABLE `yc_category`
  ADD CONSTRAINT `FK_CATEGORY_MODEL` FOREIGN KEY (`model_id`) REFERENCES `yc_model` (`model_id`);

--
-- 限制表 `yc_comments`
--
ALTER TABLE `yc_comments`
  ADD CONSTRAINT `FK_CONTENT_COMMENTS` FOREIGN KEY (`content_id`) REFERENCES `yc_contents` (`content_id`);

--
-- 限制表 `yc_contents`
--
ALTER TABLE `yc_contents`
  ADD CONSTRAINT `FK_CATEGORY_CONTENTS` FOREIGN KEY (`category_id`) REFERENCES `yc_category` (`category_id`),
  ADD CONSTRAINT `FK_USER_CEONTENTS` FOREIGN KEY (`user_id`) REFERENCES `yc_users` (`user_id`);

--
-- 限制表 `yc_content_tags`
--
ALTER TABLE `yc_content_tags`
  ADD CONSTRAINT `FK_CONTENT_TAGS` FOREIGN KEY (`content_id`) REFERENCES `yc_contents` (`content_id`),
  ADD CONSTRAINT `FK_TAG_CONTENTS` FOREIGN KEY (`tag_id`) REFERENCES `yc_tags` (`tag_id`);

--
-- 限制表 `yc_imgs`
--
ALTER TABLE `yc_imgs`
  ADD CONSTRAINT `FK_TYPE_IMGS` FOREIGN KEY (`img_type_id`) REFERENCES `yc_img_type` (`img_type_id`);

--
-- 限制表 `yc_members`
--
ALTER TABLE `yc_members`
  ADD CONSTRAINT `FK_MEMBER_AREA` FOREIGN KEY (`area_id`) REFERENCES `yc_area` (`area_id`),
  ADD CONSTRAINT `FK_MEMBER_EDU_LEVEL` FOREIGN KEY (`edu_level_id`) REFERENCES `yc_edu_level` (`edu_level_id`);

--
-- 限制表 `yc_menus`
--
ALTER TABLE `yc_menus`
  ADD CONSTRAINT `FK_NAV_MENUS` FOREIGN KEY (`nav_key`) REFERENCES `yc_navs` (`nav_key`);

--
-- 限制表 `yc_model_properties`
--
ALTER TABLE `yc_model_properties`
  ADD CONSTRAINT `FK_MODEL_PROPERTIES` FOREIGN KEY (`model_id`) REFERENCES `yc_model` (`model_id`);

--
-- 限制表 `yc_oauth_members`
--
ALTER TABLE `yc_oauth_members`
  ADD CONSTRAINT `FK_MEMBER_OAUTH` FOREIGN KEY (`member_id`) REFERENCES `yc_members` (`member_id`);

--
-- 限制表 `yc_role_access`
--
ALTER TABLE `yc_role_access`
  ADD CONSTRAINT `FK_ROLE_ACCESS` FOREIGN KEY (`role_id`) REFERENCES `yc_role` (`role_id`);

--
-- 限制表 `yc_slides_imgs`
--
ALTER TABLE `yc_slides_imgs`
  ADD CONSTRAINT `FK_SLIDE_IMGS` FOREIGN KEY (`slide_key`) REFERENCES `yc_slides` (`slide_key`);

--
-- 限制表 `yc_users`
--
ALTER TABLE `yc_users`
  ADD CONSTRAINT `FK_ROLE_USERS` FOREIGN KEY (`role_id`) REFERENCES `yc_role` (`role_id`);
